...
import com.harsh.streamingapp.databinding.ItemMatchesBinding
...
class MatchesAdapter(
    ...
    class ViewHolder(private val binding: ItemMatchesBinding) : RecyclerView.ViewHolder(binding.root) {
